...
def test_evaluate_uses_zipformer_for_zipformer_checkpoint(monkeypatch) -> None:
    captured: dict[str, object] = {}
    ...
    monkeypatch.setattr(
        ...
        lambda *_args, **_kwargs: {
            ...
            "model_state_dict": {"weight": "zipformer"},
            "featurizer_config": {},
        },
    )
    monkeypatch.setattr(evaluate, "tokenizer_from_dict", lambda *_args, **_kwargs: DummyTokenizer())
    monkeypatch.setattr(evaluate, "ZipformerCTC", DummyZipformerModel)
    monkeypatch.setattr(
        evaluate,
        "SqueezeformerCTC",
